...
export function LoginForm({
  ...
  useEffect(() => {
    ...
    } else if (demoCredentials.includes("Manager")) {
      form.setValue("email", "manager@gmail.com");
      form.setValue("password", "Password@123");
    } else if (demoCredentials.includes("Employee")) {
      form.setValue("email", "employee@gmail.com");
      form.setValue("password", "Password@123");
    } else if (demoCredentials.includes("Employee1")) {
      form.setValue("email", "employee1@gmail.com");
      form.setValue("password", "Password@123");
    }
  }, [demoCredentials]);
    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <div className="flex flex-col items-center gap-2 text-center">
        ...
        <p className="text-balance text-sm text-slate-400">
          Access your ERP workspace for inventory, sales, and operations
        </p>
      </div>
