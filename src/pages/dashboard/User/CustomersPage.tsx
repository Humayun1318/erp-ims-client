    ...
    <div className="w-full max-w-7xl mx-auto px-5">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between my-8 gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-0.5">
            Manage recurring customer activity and repeat-order schedules.
          </p>
        </div>
      ...
      <div className="mb-6">
        <div className="relative max-w-md">
          ...
          <Input
            type="text"
            placeholder="Search customer schedules by title or category..."
            value={searchTerm}
          ...
          {recurringTransactions.length === 0 && debouncedSearch ? (
            <div className="border border-muted rounded-md py-16 flex items-center justify-center">
              <p className="text-muted-foreground text-sm">
                No customer schedules found matching "{debouncedSearch}"
              </p>
            </div>
          ) : (
            <RecurringTable
